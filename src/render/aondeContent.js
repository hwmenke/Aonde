...
export const OFFERS = [
  ...
  { id: "gru-eze", origem: "GRU", destino: "EZE", cidade: "Buenos Aires", local: "Argentina", preco: "R$ 1.570", preco_usd: "$322", media: "R$ 1.950", economia: "R$ 380", cia: "SWISS", datas: "12–19 set", tipo: "Internacional", publicadoEm: "2026-08-21T00:00:00Z", get publicado() { return formatRelativePublicado(this.publicadoEm); }, erro: false, badge: "Direto · SWISS",
    pageTitle: "São Paulo–Buenos Aires em setembro: voo direto SWISS e uma semana na cidade",
    ...
    ogCredit: "Obelisco, Buenos Aires — Roberto Fiadone, CC BY-SA 4.0",
    ogCreditHref: "https://commons.wikimedia.org/wiki/Category:Obelisco_de_Buenos_Aires",
    texto: "São Paulo–Buenos Aires, 12 a 19 de setembro de 2026, SWISS direto. Duas consultas, duas datas: R$ 1.570 no Google Flights em 21 de agosto de 2026; USD $322 no Aviasales em 28 de agosto de 2026, com botão Buy, saindo de GRU. O dólar não é o real.",
    dicas: [
      "SWISS direto. Ida sábado 12 set, chegada 10h50 em EZE. Volta sábado 19 set, voo 13h30 EZE.",
      "USD $322 no Aviasales, 28 de agosto de 2026, saindo de GRU. Não vale para outra origem.",
      "R$ 1.570 é consulta no Google Flights de 21 de agosto de 2026. Não é o $322 em reais.",
    ],
    flex: [{ d: "12–19 set", p: "R$ 1.570" }],
    aviasalesUrl: "https://www.aviasales.com/search/GRU1209BUE19091",
    fontePreco: "Google Flights",
    fontePrecoEm: "2026-08-21" },
  { id: "gru-fln", origem: "GRU", destino: "FLN", cidade: "Florianópolis", local: "Santa Catarina", preco: "R$ 1.566", cia: "GOL", datas: "27 set–3 out", tipo: "Nacional", publicadoEm: "2026-08-21T00:15:00Z", get publicado() { return formatRelativePublicado(this.publicadoEm); }, erro: false, badge: "Direto · GOL",
    ...
    ogCredit: "Ponte Hercílio Luz, Florianópolis",
    ogCreditHref: "https://commons.wikimedia.org/wiki/Category:Hercílio_Luz_Bridge",
    texto: "São Paulo–Florianópolis, 27 de setembro a 3 de outubro de 2026, GOL direto, saindo e voltando de GRU. R$ 1.566 no Google Flights em 10 de setembro de 2026 — consulta, não preço de reserva. No Aviasales, em 10 de setembro de 2026, a busca desta janela estava bloqueada, sem botão Buy.",
    dicas: [
      "GOL direto. Ida domingo 27 set, 16h50 GRU → 18h00 FLN. Volta sábado 3 out, 19h30 FLN → 20h50 GRU.",
      "R$ 1.566 é consulta no Google Flights de 10 de setembro de 2026. Não é preço de reserva.",
      "Aviasales, 10 de setembro de 2026: busca bloqueada, sem botão Buy. Sem tarifa em dólar nesta data.",
    ],
    flex: [{ d: "27 set–3 out", p: "R$ 1.566" }],
    aviasalesUrl: "https://www.aviasales.com/search/GRU2709FLN03101",
    aviasalesBuy: false,
    fontePreco: "Google Flights",
    fontePrecoEm: "2026-09-10",
    ctaLabel: "Ver busca no Aviasales →",
    ctaFine: "O link abre a busca no Aviasales. Em 10 de setembro de 2026 essa página estava bloqueada, sem botão Buy. Não é um preço de reserva.",
    shareTitulo: "Florianópolis por R$ 1.566 consulta 10 set saindo de São Paulo",
    exitSub: "O link abre o Aviasales. Em 10 de setembro de 2026 a busca desta janela estava bloqueada, sem botão Buy. Não há reserva garantida neste caminho." },
  { id: "gig-ssa", origem: "GIG", destino: "SSA", cidade: "Salvador", local: "Bahia", preco: "R$ 1.320", preco_usd: "$259", cia: "LATAM", datas: "7–14 nov", tipo: "Nacional", publicadoEm: "2026-08-21T00:30:00Z", get publicado() { return formatRelativePublicado(this.publicadoEm); }, erro: false, badge: "Direto · 2h",
    ...
    ogCredit: "Elevador Lacerda, Salvador — Wikimedia Commons",
    ogCreditHref: "https://commons.wikimedia.org/wiki/Category:Elevador_Lacerda",
    texto: "Rio de Janeiro–Salvador, 7 a 14 de novembro de 2026, LATAM direto. Duas consultas, duas datas: R$ 1.320 no Google Flights em 21 de agosto de 2026; USD $259 no Aviasales em 28 de agosto de 2026, com botão Buy, saindo de GIG. O dólar não é o real.",
    dicas: [
      "LATAM direto. Ida sábado 7 nov, 15h GIG → 17h SSA. Volta sábado 14 nov, 9h25 SSA → 11h35 GIG.",
      "USD $259 no Aviasales, 28 de agosto de 2026, saindo de GIG. Não vale para outra origem.",
      "R$ 1.320 é consulta no Google Flights de 21 de agosto de 2026. Não é o $259 em reais.",
    ],
    flex: [{ d: "7–14 nov", p: "R$ 1.320" }],
  ...
  { id: "gru-scl", origem: "GRU", destino: "SCL", cidade: "Santiago", local: "Chile", preco: "USD $268", preco_usd: "$268", cia: "Sky Airline", datas: "2–9 nov", tipo: "Internacional", publicadoEm: "2026-07-25T04:49:29Z", get publicado() { return formatRelativePublicado(this.publicadoEm); }, erro: false, badge: "Direto · Sky Airline",
    pageTitle: "São Paulo–Santiago em novembro: voo direto e uma semana entre Lastarria e a cordilheira",
    ...
    ogCredit: "Cerro San Cristóbal / Gran Torre — Omnespsx, CC BY-SA 4.0",
    ogCreditHref: "https://commons.wikimedia.org/wiki/Category:Gran_Torre_Santiago",
    texto: "São Paulo–Santiago, 2 a 9 de novembro de 2026. Sky Airline direto, USD $268 no Aviasales em 28 de agosto de 2026, saindo de GRU. LATAM direto na mesma página, USD $299 — o $268 é o direto mais barato.",
    dicas: [
      "Sky Airline direto. Ida 2 nov, 13h GRU → 17h15 SCL. Volta 9 nov, 5h SCL → 8h50 GRU.",
      "A volta sai às 5h. Fique no hotel até por volta das 2h30. É o horário do voo, não um cronômetro.",
      "USD $268 no Aviasales, 28 de agosto de 2026, saindo de GRU. Não é preço em reais.",
    ],
    flex: [{ d: "2–9 nov", p: "USD $268" }],
    aviasalesUrl: "https://www.aviasales.com/search/GRU0211SCL09111",
  ...
  { id: "rec-gig", origem: "REC", destino: "GIG", cidade: "Rio de Janeiro", local: "Rio de Janeiro", preco: "USD $270", preco_usd: "$270", cia: "Azul", datas: "10–17 out", tipo: "Nacional", publicadoEm: "2026-07-25T02:49:29Z", get publicado() { return formatRelativePublicado(this.publicadoEm); }, erro: false, badge: "Direto · Azul",
    pageTitle: "Recife–Rio de Janeiro em outubro: voo direto, Copacabana e Ipanema",
    ...
    ogCredit: "Botafogo e Pão de Açúcar — Donatas Dabravolskas, CC BY-SA 4.0",
    ogCreditHref: "https://commons.wikimedia.org/wiki/Category:Botafogo_Bay",
  ...
  { id: "for-ssa", origem: "FOR", destino: "SSA", cidade: "Salvador", local: "Bahia", preco: "USD $242", preco_usd: "$242", cia: "LATAM", datas: "3–10 out", tipo: "Nacional", publicadoEm: "2026-07-24T18:49:29Z", get publicado() { return formatRelativePublicado(this.publicadoEm); }, erro: false, badge: "Direto · 1h50",
    ...
    fontePreco: "Aviasales",
    fontePrecoEm: "2026-08-28",
    ogCredit: "Largo do Pelourinho — Paul R. Burley, CC BY-SA 4.0",
    ogCreditHref: "https://commons.wikimedia.org/wiki/File:Largo_do_Pelourinho_Salvador_2019-9754.jpg" },
  ...
  { id: "gru-brc", origem: "GRU", destino: "BRC", cidade: "Bariloche", local: "Argentina", preco: "USD $565", preco_usd: "$565", cia: "via AEP", datas: "11–18 out", tipo: "Internacional", publicadoEm: "2026-07-29T05:40:00Z", get publicado() { return formatRelativePublicado(this.publicadoEm); }, erro: false, badge: "1 parada · AEP",
    ...
    ogCredit: "Centro Cívico, Bariloche — Phil Whitehouse, CC BY 2.0",
    ogCreditHref: "https://commons.wikimedia.org/wiki/Category:Centro_Cívico_de_San_Carlos_de_Bariloche",
    texto: "São Paulo–Bariloche, 11 a 18 de outubro de 2026. 1 parada em AEP, USD $565 no Aviasales em 28 de agosto de 2026, saindo de GRU. Não é direto. Outubro não é temporada de neve: ski é julho a setembro.",
    dicas: [
      "1 parada em AEP. Chegada domingo 11 out, 22h10: só hotel. Volta domingo 18 out, voo 22h: o dia inteiro na cidade, embarque à noite.",
      "USD $565 no Aviasales, 28 de agosto de 2026, saindo de GRU. Não é preço em reais.",
      "Outubro é primavera na Patagônia: Circuito Chico e chocolate, sem ski.",
    ],
    flex: [{ d: "11–18 out", p: "USD $565" }],
    aviasalesUrl: "https://www.aviasales.com/search/GRU1110BRC18101",
    fontePreco: "Aviasales",
    fontePrecoEm: "2026-08-28" },
  ...
  { id: "poa-mvd", origem: "POA", destino: "MVD", cidade: "Montevidéu", local: "Uruguai", preco: "USD $513", preco_usd: "$513", cia: "GOL", datas: "10–17 out", tipo: "Internacional", publicadoEm: "2026-07-28T14:30:00Z", get publicado() { return formatRelativePublicado(this.publicadoEm); }, erro: false, badge: "1 parada · GRU",
    pageTitle: "Porto Alegre–Montevidéu em outubro: 1 parada, Ciudad Vieja e Colonia",
    ...
    ogCredit: "Palacio Salvo — Christian Córdova, CC BY 2.0",
    ogCreditHref: "https://commons.wikimedia.org/wiki/Category:Palacio_Salvo",
    texto: "Porto Alegre–Montevidéu, 10 a 17 de outubro de 2026. GOL, 1 parada em GRU, USD $513 no Aviasales em 28 de agosto de 2026, saindo de POA. Sem direto nesta janela.",
    dicas: [
      "GOL, 1 parada em GRU. Ida sábado 10 out, 6h POA → 12h15 MVD via GRU. Cerca de 6h15 no total.",
      "USD $513 no Aviasales, 28 de agosto de 2026, saindo de POA. Não é preço em reais. Não é direto.",
    ],
    flex: [{ d: "10–17 out", p: "USD $513" }],
    aviasalesUrl: "https://www.aviasales.com/search/POA1010MVD17101",
    fontePreco: "Aviasales",
    fontePrecoEm: "2026-08-28" },
  ...
  { id: "cgh-igu", origem: "CGH", destino: "IGU", cidade: "Foz do Iguaçu", local: "Paraná", preco: "USD $279", preco_usd: "$279", cia: "Azul / LATAM", datas: "10–17 out", tipo: "Nacional", publicadoEm: "2026-08-28T12:00:00Z", get publicado() { return formatRelativePublicado(this.publicadoEm); }, erro: false, badge: "Direto · Congonhas",
    origemCidade: "Congonhas",
    pageTitle: "Congonhas–Foz do Iguaçu em outubro: voo direto e as cataratas",
    thumbUrl: wiki("Cataratas do Iguaçu, Paraná.jpg"), credit: "Cataratas do Iguaçu — Wikimedia Commons", creditHref: "https://commons.wikimedia.org/wiki/Category:Iguazu_Falls",
    ogCredit: "Iguaçu Falls — Emesbe, CC BY-SA 3.0",
    ogCreditHref: "https://commons.wikimedia.org/wiki/Category:Iguazu_Falls",
    texto: "Congonhas–Foz do Iguaçu, 10 a 17 de outubro de 2026. USD $279 no Aviasales em 28 de agosto de 2026: Azul ida 6h25 CGH → 8h15 IGU e LATAM volta 5h15 IGU → 6h50 CGH, o direto mais barato nos dois sentidos. Origem Congonhas, não GRU.",
    dicas: [
      "Azul ida sábado 10 out, 6h25 CGH → 8h15 IGU. LATAM volta sábado 17 out, 5h15 IGU → 6h50 CGH.",
      "A volta às 5h15 é madrugada: saia do hotel de madrugada. É o horário do voo, não um cronômetro.",
      "USD $279 no Aviasales, 28 de agosto de 2026, saindo de CGH. Wrap CGH1010IGU17101. Não é preço em reais.",
    ],
    flex: [{ d: "10–17 out", p: "USD $279" }],
    aviasalesUrl: "https://www.aviasales.com/search/CGH1010IGU17101",
    fontePreco: "Aviasales",
    fontePrecoEm: "2026-08-28" },
];
...
export const OFFER_COORDS = {
  ...
  "cgh-igu": { lat: -25.6953, lng: -54.4367 }, // Foz do Iguaçu
};
...
export const GRU_FLN_SEMANA = {
  ...
  voo: "GOL direto. Ida domingo 27 set, 16h50 GRU → 18h00 FLN. Volta sábado 3 out, 19h30 FLN → 20h50 GRU. Horários da consulta no Google Flights em 10 de setembro de 2026.",
  tarifa: "R$ 1.566",
  tarifaFonte: "Google Flights",
  tarifaFonteEm: "2026-09-10",
  fareNote: "R$ 1.566 é consulta no Google Flights de 10 de setembro de 2026, GOL direto, saindo e voltando de GRU. Não é preço de reserva. No Aviasales, em 10 de setembro de 2026, a busca desta janela estava bloqueada — sem botão Buy. Sem tarifa em dólar nesta data.",
  hospedagem: "Lagoa da Conceição. Barra da Lagoa e Joaquina ficam perto. Centro, norte e sul pedem carro ou app.",
  conferencia: "Restaurantes conferidos em 28 de agosto de 2026 nos sites das casas (Box 32, Ostradamus, Ammo Beach) e em páginas públicas (Oliveira, Bar do Arante). Horários do voo da consulta no Google Flights em 10 de setembro de 2026: GOL direto, 16h50 GRU → 18h00 FLN / 19h30 FLN → 20h50 GRU.",
  guiaHref: "/guias/florianopolis",
  guiaLabel: "Roteiro de 5 dias em Florianópolis, sem as datas desta passagem →",
  dias: [
    { n: 1, titulo: "Domingo 27, chegada", desc: "Voo 18h00. Check-in na Lagoa. Box 32 fecha domingo.",
    ...
    { n: 6, titulo: "Sexta 2, Lagoa e Mole", desc: "Barra da Lagoa, Praia Mole. Sem restaurante novo: jantar de novo no Oliveira (sexta costuma ir mais tarde) ou voltar cedo.",
      ...
      restauranteEndereco: "Rua Henrique Veras do Nascimento 57, Lagoa da Conceição" },
    { n: 7, titulo: "Sábado 3, saída", desc: "Voo 19h30. Sem restaurante.",
      pontos: [] },
  ],
};

const AVISO_EDITORIAL =
  "Editorial, escrito em 28 de agosto de 2026. Não é um texto de quem mora aí. Cada restaurante abaixo existia nessa data, conferido em fonte pública.";

// Semana editorial GRU-EZE (12–19 set 2026). Vive em /ofertas/gru-eze —
// o guia de 5 dias /guias/buenosaires e /hoje nao crescem esta janela.
export const GRU_EZE_SEMANA = {
  offerId: "gru-eze",
  titulo: "Buenos Aires, 12 a 19 de setembro de 2026",
  janela: "12 a 19 de setembro de 2026",
  origem: "GRU",
  destino: "EZE",
  cidade: "Buenos Aires",
  escritoEm: "2026-08-28",
  aviso: AVISO_EDITORIAL,
  rota: "São Paulo (GRU) → Buenos Aires (EZE).",
  voo: "SWISS direto. Ida sábado 12 set, chegada 10h50 em EZE. Volta sábado 19 set, voo 13h30 EZE.",
  tarifa: "USD $322",
  tarifaFonte: "Aviasales",
  tarifaFonteEm: "2026-08-28",
  fareNote: "O USD $322 é a tarifa vista no Aviasales em 28 de agosto de 2026, saindo de GRU. O R$ 1.570 é outra consulta, no Google Flights em 21 de agosto de 2026. Não misture: o dólar não é o real.",
  hospedagem: "Palermo Soho ou Palermo Viejo: Don Julio e a caminhada de quarta ficam a pé. Recoleta é a alternativa mais quieta. Não durma em San Telmo — a feira de domingo é visita, não base; e não durma na Defensa.",
  reservas: "Don Julio: donjulio.meitre.com. Sem hotel nomeado.",
  conferencia: "Restaurantes conferidos em 28 de agosto de 2026 em páginas públicas (Café Tortoni, El Desnivel, Don Julio, Cabaña Las Lilas).",
  guiaHref: "/guias/buenosaires",
  guiaLabel: "Roteiro de 5 dias em Buenos Aires, sem as datas desta passagem →",
  dias: [
    { n: 1, titulo: "Sábado 12, chegada", desc: "Chegada 10h50. Plaza de Mayo, Avenida de Mayo.",
      pontos: [{ nome: "Plaza de Mayo" }, { nome: "Avenida de Mayo" }],
      restaurante: "Café Tortoni",
      restauranteNota: "Av. de Mayo 825. Aberto 8h–21h todos os dias.",
      restauranteEndereco: "Av. de Mayo 825" },
    { n: 2, titulo: "Domingo 13, feira de San Telmo", desc: "Feira na Plaza Dorrego. Não conte com El Desnivel neste dia.",
      pontos: [{ nome: "Feira de San Telmo", nota: "Plaza Dorrego" }],
      restaurante: "Choripán na feira",
      restauranteNota: "Na feira, ou jantar no Don Julio se a reserva tiver saído. Não conte com El Desnivel no domingo.",
      restauranteEndereco: "Plaza Dorrego, San Telmo" },
    { n: 3, titulo: "Segunda 14, Recoleta", desc: "Cemitério da Recoleta, Floralis Genérica. El Desnivel fecha segunda.",
      pontos: [{ nome: "Cemitério da Recoleta" }, { nome: "Floralis Genérica" }] },
    { n: 4, titulo: "Terça 15, San Telmo",
      pontos: [{ nome: "San Telmo" }],
      restaurante: "El Desnivel",
      restauranteNota: "Defensa 855. +54 11 4300-9081.",
      restauranteEndereco: "Defensa 855" },
    { n: 5, titulo: "Quarta 16, Palermo", desc: "Bosques, MALBA, Palermo Soho. A pé se a base for Soho/Viejo.",
      pontos: [{ nome: "Bosques de Palermo" }, { nome: "MALBA" }, { nome: "Palermo Soho" }],
      restaurante: "Don Julio",
      restauranteNota: "Guatemala 4699. donjulio.meitre.com. 11h30–16h e 19h–1h.",
      restauranteEndereco: "Guatemala 4699" },
    { n: 6, titulo: "Quinta 17, La Boca de dia", desc: "La Boca de dia, em grupo. Puerto Madero.",
      pontos: [{ nome: "La Boca", nota: "de dia, em grupo" }, { nome: "Puerto Madero" }],
      restaurante: "Cabaña Las Lilas",
      restauranteNota: "Alicia Moreau de Justo 516.",
      restauranteEndereco: "Alicia Moreau de Justo 516" },
    { n: 7, titulo: "Sexta 18, Tigre", desc: "Tigre: trem Mitre + barco. Sem restaurante novo.",
      pontos: [{ nome: "Tigre", nota: "trem Mitre e barco" }] },
    { n: 8, titulo: "Sábado 19, saída", desc: "Voo 13h30 EZE. Sem restaurante.",
      pontos: [] },
  ],
};

// Semana editorial GIG-SSA (7–14 nov 2026). Mesmos restaurantes da semana
// FOR-SSA porque os dias da semana coincidem. Ofertas separadas — nao misturar
// o cartao FOR-SSA (Pelourinho) com GIG-SSA (Elevador). Vive em /ofertas/gig-ssa.
export const GIG_SSA_SEMANA = {
  offerId: "gig-ssa",
  titulo: "Salvador, 7 a 14 de novembro de 2026",
  janela: "7 a 14 de novembro de 2026",
  origem: "GIG",
  destino: "SSA",
  cidade: "Salvador",
  escritoEm: "2026-08-28",
  aviso: AVISO_EDITORIAL,
  rota: "Rio de Janeiro (GIG) → Salvador (SSA).",
  voo: "LATAM direto. Ida sábado 7 nov, 15h GIG → 17h SSA. Volta sábado 14 nov, 9h25 SSA → 11h35 GIG. A volta às 9h25 pede saída cedo do Rio Vermelho. É o horário do voo, não um cronômetro.",
  tarifa: "USD $259",
  tarifaFonte: "Aviasales",
  tarifaFonteEm: "2026-08-28",
  fareNote: "O USD $259 é a tarifa vista no Aviasales em 28 de agosto de 2026, saindo de GIG. O R$ 1.320 é outra consulta, no Google Flights em 21 de agosto de 2026. Não misture: o dólar não é o real.",
  hospedagem: "Rio Vermelho. Casa de Tereza, Dona Mariquita e o acarajé da Dinha ficam a pé. Pelourinho e Barra são Uber (20–30 min).",
  reservas: "Casa de Tereza (jantar) e Origem (terça a sábado, 19h, só com reserva).",
  conferencia: "Restaurantes conferidos em 28 de agosto de 2026 nas mesmas fontes da janela Fortaleza–Salvador (Dinha, Senac, Dona Mariquita, Casa de Tereza, Origem, Pereira).",
  guiaHref: "/guias/salvador",
  guiaLabel: "Roteiro de 5 dias em Salvador, sem as datas desta passagem →",
  dias: [
    { n: 1, titulo: "Sábado 7, chegada", desc: "Voo às 17h. Check-in no Rio Vermelho.",
      pontos: [{ nome: "Largo da Mariquita", nota: "Fim de tarde, de frente para o mar." }],
      restaurante: "Acarajé da Dinha",
      restauranteNota: "Praça de Santana, desde 1967.",
      restauranteEndereco: "Praça de Santana, Rio Vermelho" },
    { n: 2, titulo: "Domingo 8, Pelourinho",
      pontos: [
        { nome: "Igreja de São Francisco" },
        { nome: "Largo do Pelourinho" },
        { nome: "Fundação Casa de Jorge Amado" },
      ...
      restauranteNota: "Largo do Pelourinho 13. Buffet típico 11h30–15h30, inclusive domingo. ~40 pratos baianos; em 2026 o site do Senac cobrava cerca de R$ 110 no fim de semana. Reserva: senacpelourinho@ba.senac.br.",
      restauranteEndereco: "Largo do Pelourinho 13" },
    { n: 3, titulo: "Segunda 9, Bonfim e Cidade Baixa",
      pontos: [
        { nome: "Igreja do Bonfim" },
        { nome: "Ponta de Humaitá" },
      ],
      restaurante: "Dona Mariquita",
      restauranteNota: "Av. da França, Comércio. Aberto 12h–17h, todos os dias. Não abre à noite.",
      restauranteEndereco: "Av. da França, Comércio" },
    { n: 4, titulo: "Terça 10, Rio Vermelho",
      pontos: [{ nome: "Casa do Rio Vermelho", nota: "Jorge Amado e Zélia" }],
      restaurante: "Casa de Tereza",
      restauranteNota: "Rua Odilon Santos 45. Reserva. casadetereza.com.br.",
      restauranteEndereco: "Rua Odilon Santos 45" },
    { n: 5, titulo: "Quarta 11, Origem",
      pontos: [{ nome: "Caminho das Árvores" }],
      restaurante: "Origem",
      restauranteNota: "Alameda das Algarobas 74, Caminho das Árvores. Terça a sábado, 19h, só reserva.",
      restauranteEndereco: "Alameda das Algarobas 74, Caminho das Árvores" },
    { n: 6, titulo: "Quinta 12, Barra",
      pontos: [{ nome: "Farol da Barra" }, { nome: "Porto da Barra" }],
      restaurante: "Pereira",
      restauranteNota: "Av. Sete de Setembro 3959. Fecha segunda; quinta aberto.",
      restauranteEndereco: "Av. Sete de Setembro 3959" },
    { n: 7, titulo: "Sexta 13, Rio Vermelho",
      pontos: [{ nome: "Rio Vermelho" }],
      restaurante: "Dona Mariquita",
      restauranteNota: "Rua do Meio 178. Só até 17h.",
      restauranteEndereco: "Rua do Meio 178, Rio Vermelho" },
    { n: 8, titulo: "Sábado 14, saída", desc: "Voo 9h25. Saia cedo do Rio Vermelho. Sem restaurante.",
      pontos: [] },
  ],
};

// Semana editorial GRU-SCL (2–9 nov 2026). Nao ha guia de 5 dias de Santiago;
// nao inventar restaurante extra. Vive em /ofertas/gru-scl, nao em /hoje.
export const GRU_SCL_SEMANA = {
  offerId: "gru-scl",
  titulo: "Santiago, 2 a 9 de novembro de 2026",
  janela: "2 a 9 de novembro de 2026",
  origem: "GRU",
  destino: "SCL",
  cidade: "Santiago",
  escritoEm: "2026-08-28",
  aviso: AVISO_EDITORIAL,
  rota: "São Paulo (GRU) → Santiago (SCL).",
  voo: "Sky Airline direto. Ida 2 nov, 13h GRU → 17h15 SCL. Volta 9 nov, 5h SCL → 8h50 GRU.",
  horaArmadilha: "A volta do dia 9 de novembro sai às 5h de SCL (chega 8h50 GRU). Fique no hotel até por volta das 2h30. Sem isso o voo parece uma manhã normal. É o horário do voo, não um cronômetro.",
  tarifa: "USD $268",
  tarifaFonte: "Aviasales",
  tarifaFonteEm: "2026-08-28",
  fareNote: "O USD $268 é o direto mais barato no Aviasales em 28 de agosto de 2026, Sky Airline, saindo de GRU. LATAM direto na mesma página: USD $299. Não é preço em reais.",
  hospedagem: "Lastarria ou Bellavista.",
  conferencia: "Bar Liguria e Donde Augusto conferidos em 28 de agosto de 2026 em páginas públicas.",
  dias: [
    { n: 1, titulo: "Segunda 2, chegada", desc: "Chegada 17h15. Jantar no Bar Liguria (fecha domingo).",
      pontos: [{ nome: "Lastarria" }],
      restaurante: "Bar Liguria",
      restauranteNota: "Merced 298. Fecha domingo.",
      restauranteEndereco: "Merced 298" },
    { n: 2, titulo: "Terça 3, Mercado Central",
      pontos: [{ nome: "Mercado Central" }],
      restaurante: "Donde Augusto",
      restauranteNota: "Local 166–162. Paila marina.",
      restauranteEndereco: "Mercado Central, local 166–162" },
    { n: 3, titulo: "Quarta 4, San Cristóbal", desc: "Cerro San Cristóbal, Bellavista. Sem casa nova.",
      pontos: [{ nome: "Cerro San Cristóbal" }, { nome: "Bellavista" }] },
    { n: 4, titulo: "Quinta 5, Valparaíso", desc: "Day trip a Valparaíso. Sem casa nova.",
      pontos: [{ nome: "Valparaíso" }] },
    { n: 5, titulo: "Sexta 6, Lastarria", desc: "Lastarria e museus. Liguria de novo serve.",
      pontos: [{ nome: "Lastarria" }, { nome: "Museus de Lastarria" }],
      restaurante: "Bar Liguria",
      restauranteNota: "de novo. Merced 298.",
      restauranteEndereco: "Merced 298" },
    { n: 6, titulo: "Sábado 7, Maipo", desc: "Cajón del Maipo ou vinícola no Maipo. Sem casa nova.",
      pontos: [{ nome: "Cajón del Maipo", nota: "ou vinícola no Maipo" }] },
    { n: 7, titulo: "Domingo 8, Forestal", desc: "Liguria fecha domingo. Parque Forestal. Sem restaurante novo.",
      pontos: [{ nome: "Parque Forestal" }] },
    { n: 8, titulo: "Segunda 9, saída", desc: "Voo 5h. Sem refeição marcada.",
      pontos: [] },
  ],
};

// Semana editorial REC-GIG (10–17 out 2026). Vive em /ofertas/rec-gig.
// Nao despejar barraca generica de praia. Guia de 5 dias do Rio fica intacto.
export const REC_GIG_SEMANA = {
  offerId: "rec-gig",
  titulo: "Rio de Janeiro, 10 a 17 de outubro de 2026",
  janela: "10 a 17 de outubro de 2026",
  origem: "REC",
  destino: "GIG",
  cidade: "Rio de Janeiro",
  escritoEm: "2026-08-28",
  aviso: AVISO_EDITORIAL,
  rota: "Recife (REC) → Rio de Janeiro (GIG).",
  voo: "Azul direto. Ida sábado 10 out, 8h15 REC → 11h10 GIG. Volta sábado 17 out, 16h20 GIG → 19h05 REC.",
  tarifa: "USD $270",
  tarifaFonte: "Aviasales",
  tarifaFonteEm: "2026-08-28",
  ...
  guiaHref: "/guias/rio",
  guiaLabel: "Roteiro de 5 dias no Rio, sem as datas desta passagem →",
  dias: [
    { n: 1, titulo: "Sábado 10, chegada", desc: "Chegada 11h10. Calçadão, pôr do sol no Arpoador.",
      pontos: [{ nome: "Calçadão de Copacabana" }, { nome: "Arpoador", nota: "pôr do sol" }] },
    { n: 2, titulo: "Domingo 11, Ipanema", desc: "Ipanema, posto 9.",
      pontos: [{ nome: "Ipanema", nota: "posto 9" }] },
    { n: 3, titulo: "Segunda 12, Urca",
      pontos: [{ nome: "Mureta da Urca" }],
      restaurante: "Bar Urca",
      restauranteNota: "Bolinho de bacalhau na mureta.",
      restauranteEndereco: "Bar Urca, Urca" },
    { n: 4, titulo: "Terça 13, Cristo e Santa Teresa", desc: "Cristo cedo, Santa Teresa. Jantar no Aprazível (reserve).",
      pontos: [{ nome: "Cristo Redentor", nota: "cedo" }, { nome: "Santa Teresa" }],
      restaurante: "Aprazível",
      restauranteNota: "Reserve.",
      restauranteEndereco: "Santa Teresa" },
    { n: 5, titulo: "Quarta 14, Centro e Pão de Açúcar", desc: "Centro de manhã. Pão de Açúcar no fim da tarde.",
      pontos: [{ nome: "Centro do Rio" }, { nome: "Pão de Açúcar", nota: "fim da tarde" }],
      restaurante: "Confeitaria Colombo",
      restauranteNota: "Salão de 1894.",
      restauranteEndereco: "Confeitaria Colombo, Centro" },
    { n: 6, titulo: "Quinta 15, Jardim Botânico",
      pontos: [{ nome: "Jardim Botânico" }, { nome: "Lagoa" }],
      restaurante: "Braseiro da Gávea",
      restauranteEndereco: "Gávea" },
    { n: 7, titulo: "Sexta 16, praia", desc: "Praia. Sem casa nova.",
      pontos: [{ nome: "Praia de Ipanema ou Copacabana" }] },
    { n: 8, titulo: "Sábado 17, saída", desc: "Voo 16h20. Sem restaurante.",
      pontos: [] },
  ],
};

// Semana editorial POA-MVD (10–17 out 2026). 1 parada, nao direto.
// Nao listar Charco (nao reabriu em 28 ago). Vive em /ofertas/poa-mvd.
export const POA_MVD_SEMANA = {
  offerId: "poa-mvd",
  titulo: "Montevidéu, 10 a 17 de outubro de 2026",
  janela: "10 a 17 de outubro de 2026",
  origem: "POA",
  destino: "MVD",
  cidade: "Montevidéu",
  escritoEm: "2026-08-28",
  aviso: AVISO_EDITORIAL,
  rota: "Porto Alegre (POA) → Montevidéu (MVD).",
  voo: "GOL, 1 parada em GRU. Ida sábado 10 out, 6h POA → 12h15 MVD via GRU. Sem direto nesta janela. Volta sábado 17: 1 parada; confirme no wrap. Há um regresso rotulado “ótimo” a USD $532, 18h40, que chega 1h15 — outro voo, outro preço, não é o $513.",
  tarifa: "USD $513",
  tarifaFonte: "Aviasales",
  tarifaFonteEm: "2026-08-28",
  fareNote: "O USD $513 é a tarifa GOL 1 parada vista no Aviasales em 28 de agosto de 2026, saindo de POA. Não é direto. Não é preço em reais.",
  hospedagem: "Ciudad Vieja ou Pocitos.",
  conferencia: "El Palenque no Mercado del Puerto conferido em 28 de agosto de 2026.",
  guiaHref: "/guias/montevideu",
  guiaLabel: "Roteiro de 5 dias em Montevidéu, sem as datas desta passagem →",
  dias: [
    { n: 1, titulo: "Sábado 10, chegada", desc: "Chegada 12h15. Plaza Independencia, Palacio Salvo. Almoço no Mercado del Puerto.",
      pontos: [{ nome: "Plaza Independencia" }, { nome: "Palacio Salvo" }],
      restaurante: "El Palenque",
      restauranteNota: "Mercado del Puerto.",
      restauranteEndereco: "Mercado del Puerto" },
    { n: 2, titulo: "Domingo 11, Rambla", desc: "Rambla, Pocitos, Feria Tristán Narvaja (domingo).",
      pontos: [{ nome: "Rambla" }, { nome: "Pocitos" }, { nome: "Feria Tristán Narvaja", nota: "domingo" }] },
    { n: 3, titulo: "Segunda 12, Ciudad Vieja",
      pontos: [{ nome: "Teatro Solís" }, { nome: "Barrio Sur" }] },
    { n: 4, titulo: "Terça 13, Colonia", desc: "Balsa para Colonia del Sacramento. Volta à noite.",
      pontos: [{ nome: "Colonia del Sacramento", nota: "balsa; volta à noite" }] },
    { n: 5, titulo: "Quarta 14, Pocitos", desc: "Pocitos e Punta Carretas. Sem casa nova.",
      pontos: [{ nome: "Pocitos" }, { nome: "Punta Carretas" }] },
    { n: 6, titulo: "Quinta 15, Ciudad Vieja", desc: "Ciudad Vieja. El Palenque de novo serve.",
      pontos: [{ nome: "Ciudad Vieja" }],
      restaurante: "El Palenque",
      restauranteNota: "de novo. Mercado del Puerto.",
      restauranteEndereco: "Mercado del Puerto" },
    { n: 7, titulo: "Sexta 16, Parque Rodó",
      pontos: [{ nome: "Parque Rodó" }] },
    { n: 8, titulo: "Sábado 17, saída", desc: "Volta 1 parada; confirme no wrap. Sem restaurante.",
      pontos: [] },
  ],
};

// Semana editorial CGH-IGU (10–17 out 2026). Origem Congonhas, nao GRU.
// Wrap so CGH1010IGU17101. Vive em /ofertas/cgh-igu; nao entra em /hoje.
export const CGH_IGU_SEMANA = {
  offerId: "cgh-igu",
  titulo: "Foz do Iguaçu, 10 a 17 de outubro de 2026",
  janela: "10 a 17 de outubro de 2026",
  origem: "CGH",
  destino: "IGU",
  ...
  escritoEm: "2026-08-28",
  aviso: AVISO_EDITORIAL,
  rota: "Congonhas (CGH) → Foz do Iguaçu (IGU).",
  voo: "Azul ida sábado 10 out, 6h25 CGH → 8h15 IGU. LATAM volta sábado 17 out, 5h15 IGU → 6h50 CGH — o par do USD $279.",
  horaArmadilha: "A volta do dia 17 de outubro sai às 5h15 de IGU (chega 6h50 CGH). Madrugada: saia do hotel de madrugada. Sem isso o voo parece uma manhã normal. É o horário do voo, não um cronômetro.",
  tarifa: "USD $279",
  tarifaFonte: "Aviasales",
  tarifaFonteEm: "2026-08-28",
  fareNote: "O USD $279 é o direto mais barato nos dois sentidos no Aviasales em 28 de agosto de 2026, wrap CGH1010IGU17101, saindo de Congonhas. Na mesma página há um all-LATAM a USD $372 (11h10→12h55 / 17h35→19h10) — outro par, não o preço desta página. Não é preço em reais.",
  hospedagem: "Avenida das Cataratas.",
  conferencia: "Porto Canoas e Búfalo Branco conferidos em 28 de agosto de 2026 em páginas públicas. Vila Yá: não conferimos de novo o site nessa data.",
  guiaHref: "/guias/foz",
  guiaLabel: "Roteiro de 4 dias em Foz do Iguaçu, sem as datas desta passagem →",
  dias: [
    { n: 1, titulo: "Sábado 10, chegada", desc: "Chegada 8h15 no par do USD $279. Check-in na avenida das Cataratas.",
      pontos: [{ nome: "Avenida das Cataratas" }] },
    { n: 2, titulo: "Domingo 11, lado brasileiro", desc: "Cataratas pelo lado brasileiro. Almoço no Porto Canoas, dentro do parque.",
      pontos: [{ nome: "Cataratas do Iguaçu", nota: "lado brasileiro" }],
      restaurante: "Porto Canoas",
      restauranteNota: "Dentro do parque.",
      restauranteEndereco: "Parque Nacional do Iguaçu" },
    { n: 3, titulo: "Segunda 12, lado argentino", desc: "Cataratas pela Argentina. Leve passaporte.",
      pontos: [{ nome: "Cataratas do Iguaçu", nota: "lado argentino; passaporte" }] },
    { n: 4, titulo: "Terça 13, Itaipu",
      pontos: [{ nome: "Usina de Itaipu" }, { nome: "Marco das Três Fronteiras" }] },
    { n: 5, titulo: "Quarta 14, Parque das Aves",
      pontos: [{ nome: "Parque das Aves" }] },
    { n: 6, titulo: "Quinta 15, Búfalo Branco",
      pontos: [{ nome: "Foz do Iguaçu" }],
      restaurante: "Búfalo Branco",
      restauranteEndereco: "Foz do Iguaçu" },
    { n: 7, titulo: "Sexta 16, livre", desc: "Dia livre. Vila Yá só se você aceitar que não conferimos de novo o site em 28 de agosto de 2026.",
      pontos: [{ nome: "Foz do Iguaçu" }] },
    { n: 8, titulo: "Sábado 17, saída", desc: "Voo 5h15 se o CTA for o USD $279. Sem restaurante.",
      pontos: [] },
  ],
};

// Semana editorial GRU-BRC (11–18 out 2026). 1 parada AEP. Outubro nao e
// neve. Vive em /ofertas/gru-brc; o guia de ski de 5 dias fica intacto.
export const GRU_BRC_SEMANA = {
  offerId: "gru-brc",
  titulo: "Bariloche, 11 a 18 de outubro de 2026",
  janela: "11 a 18 de outubro de 2026",
  origem: "GRU",
  destino: "BRC",
  cidade: "Bariloche",
  escritoEm: "2026-08-28",
  aviso: AVISO_EDITORIAL,
  rota: "São Paulo (GRU) → Bariloche (BRC).",
  voo: "1 parada em AEP. Chegada domingo 11 out, 22h10: só hotel. Volta domingo 18 out, voo 22h: o dia inteiro na cidade, embarque à noite. Outubro não é temporada de neve (ski é julho a setembro).",
  tarifa: "USD $565",
  tarifaFonte: "Aviasales",
  tarifaFonteEm: "2026-08-28",
  fareNote: "O USD $565 é a tarifa 1 parada em AEP vista no Aviasales em 28 de agosto de 2026, saindo de GRU. Não é direto. Não é preço em reais.",
  hospedagem: "Centro, perto da Mitre.",
  conferencia: "El Boliche de Alberto e Cervecería Patagonia conferidos em 28 de agosto de 2026 em páginas públicas.",
  guiaHref: "/guias/bariloche",
  guiaLabel: "Roteiro de 5 dias em Bariloche, sem as datas desta passagem →",
  dias: [
    { n: 1, titulo: "Domingo 11, chegada", desc: "Chegada 22h10. Só hotel.",
      pontos: [] },
    { n: 2, titulo: "Segunda 12, centro", desc: "Centro Cívico, Mitre, chocolate.",
      pontos: [{ nome: "Centro Cívico" }, { nome: "Calle Mitre", nota: "chocolate" }],
      restaurante: "El Boliche de Alberto",
      restauranteEndereco: "Bariloche" },
    { n: 3, titulo: "Terça 13, Circuito Chico", desc: "Circuito Chico, Nahuel Huapi. Cervecería Patagonia no lago Moreno antes do pôr do sol.",
      pontos: [{ nome: "Circuito Chico" }, { nome: "Lago Nahuel Huapi" }],
      restaurante: "Cervecería Patagonia",
      restauranteNota: "Lago Moreno, antes do pôr do sol.",
      restauranteEndereco: "Lago Moreno" },
    { n: 4, titulo: "Quarta 14, Cerro Otto", desc: "Cerro Otto / campanário se estiver aberto na primavera.",
      pontos: [{ nome: "Cerro Otto", nota: "campanário, se aberto na primavera" }] },
    { n: 5, titulo: "Quinta 15, lagos", desc: "Colonia Suiza ou outro circuito de lagos.",
      pontos: [{ nome: "Colonia Suiza", nota: "ou outro circuito de lagos" }] },
    { n: 6, titulo: "Sexta 16, centro", desc: "El Boliche de novo.",
      pontos: [{ nome: "Centro de Bariloche" }],
      restaurante: "El Boliche de Alberto",
      restauranteNota: "de novo.",
      restauranteEndereco: "Bariloche" },
    { n: 7, titulo: "Sábado 17, livre", desc: "Dia livre. Sem casa nova.",
      pontos: [{ nome: "Bariloche" }] },
    { n: 8, titulo: "Domingo 18, saída", desc: "Dia inteiro na cidade. Voo 22h. Sem restaurante.",
      pontos: [] },
  ],
};
...
attachLockWeek(GRU_EZE_SEMANA);
attachLockWeek(GIG_SSA_SEMANA);
attachLockWeek(GRU_SCL_SEMANA);
attachLockWeek(REC_GIG_SEMANA);
