...
const BASE_GUIDES = {
  ...
  salvador: {
    ...
    // 28 de agosto de 2026; nao e voz de quem mora em Salvador. O roteiro de
    // 5 dias acima continua no /hoje do GIG-SSA. Esta semana aparece em
    // /guias/salvador e /ofertas/for-ssa.
    semanaForSsa: {
      offerId: "for-ssa",
