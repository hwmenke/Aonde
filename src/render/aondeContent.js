...
export const OFFERS = [
  ...
  { id: "gru-fln", origem: "GRU", destino: "FLN", cidade: "Florianópolis", local: "Santa Catarina", preco: "R$ 770", preco_usd: "$158", cia: "LATAM", datas: "27 set–3 out", tipo: "Nacional", publicadoEm: "2026-08-21T00:15:00Z", get publicado() { return formatRelativePublicado(this.publicadoEm); }, erro: false, badge: "Direto · 1h15",
    ...
    texto: "São Paulo–Florianópolis, 27 de setembro a 3 de outubro de 2026, LATAM direto. Duas consultas, duas datas: R$ 770 no Google Flights em 21 de agosto de 2026; USD $158 no Aviasales em 1º de setembro de 2026 (em 28 de agosto estava USD $153), com botão Buy, saindo de GRU. O dólar não é o real.",
    dicas: [
      "LATAM direto. Ida domingo 27 set, 9h50 GRU → 11h05 FLN. Volta sábado 3 out, 10h35 FLN → 11h55 GRU.",
      "USD $158 no Aviasales, 1º de setembro de 2026, saindo de GRU (em 28 de agosto estava USD $153). Não vale para outra origem.",
      "R$ 770 é consulta no Google Flights de 21 de agosto de 2026. Não é o $158 em reais.",
    ],
...
export const GRU_FLN_SEMANA = {
  ...
  voo: "LATAM direto. Ida domingo 27 set, 9h50 GRU → 11h05 FLN. Volta sábado 3 out, 10h35 FLN → 11h55 GRU. Horários reconsultados em 1 de setembro de 2026.",
  tarifa: "USD $158",
  tarifaFonte: "Aviasales",
  tarifaFonteEm: "2026-09-01",
  fareNote: "O USD $158 é a tarifa vista no Aviasales em 1 de setembro de 2026, saindo de GRU (em 28 de agosto estava USD $153). O R$ 770 é outra consulta, no Google Flights em 21 de agosto de 2026. Não misture: o dólar não é o real.",
  hospedagem: "Lagoa da Conceição. Barra da Lagoa e Joaquina ficam perto. Centro, norte e sul pedem carro ou app.",
  conferencia: "Restaurantes conferidos em 28 de agosto de 2026 nos sites das casas (Box 32, Ostradamus, Ammo Beach) e em páginas públicas (Oliveira, Bar do Arante). Horários do voo reconsultados em 1 de setembro de 2026: ainda LATAM direto 9h50 GRU / 10h35 FLN.",
